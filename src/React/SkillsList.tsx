...
const SkillsList = () => {
  ...
  const skills = {
    ...
    "Base de datos" : [
      ...
      "Desarrollo de mejoras y correciones",
    ],
    "Diseño y Prototipos UI/UX" : [
      "Diseños UI con Adobe XD y Figma",
      "Iconografia y estilizados personalizados con Adobe Photoshop",
      "Prototipos web y mobile con Adobe XD",
    ],
